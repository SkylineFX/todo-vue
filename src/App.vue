...
<template>
  <header class="w-full h-[25vh] lg:min-h-[17.5rem] lg:h-[30vh]">
    <Header/>
  </header>
...
<style>
  #app {
    @apply w-[100vw] min-h-[100vh] bg-light-gray-200 dark:bg-dark-gray-500 ease-linear duration-100 font-['Josefin_Sans'];
  }
</style>